  ...
  return (
    <div className="home">
        ...
        <div className="homeIntro">
          ...
          <div>
            <h2 className="img"><img src="/myFoto.png" alt="" /></h2>
          </div>
        </div>
        ...
        <div className="projects">
          <div className="aboutProjects">
            <p>Meus projetos</p>
            <span>Desenvolvi diversos projetos pessoais na área de desenvolvimento web, que variam desde a criação de websites estáticos até a implementação de aplicativos web interativos. Em cada um desses projetos, obtive uma proficiência sólida em várias tecnologias. Esses projetos pessoais foram essenciais para o meu crescimento e especialização contínuos na área de desenvolvimento web. </span>
          </div>
